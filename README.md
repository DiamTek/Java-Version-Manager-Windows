...
* **Built-in Self-Updater:** Run `jvm self-update` to automatically ping GitHub, download the newest build of the script into the background, atomically overwrite itself, and seamlessly bounce you back into the menu.
