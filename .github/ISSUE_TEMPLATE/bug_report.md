...
- **JVM Version & Build**: `[Run 'jvm version' or 'jvm.bat --version', e.g., 1.0.0, Build 20260911.84]`
...
<details>
<summary><b>1. <code>jvm env</code></b></summary>

```text
[Paste output of 'jvm env' here]
```
</details>

<details>
<summary><b>2. <code>where.exe java</code></b></summary>
