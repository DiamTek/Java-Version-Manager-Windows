...
* [**Installation Guide**](../docs/INSTALLATION.md) — One-line PowerShell install, MSI installers, WiX v4 build commands, and quiet unattended flags.
* [**Usage Guide**](../docs/USAGE.md) — CLI quick-switching, `.java-version` and `.sdkmanrc` auto-switching, BYO-JDK linking, and headless automation.
* [**Frequently Asked Questions (FAQ)**](../docs/FAQ.md) — Answers to UAC elevation, Symlink vs Registry mode, path persistence, and build attestation.
* [**Architecture Overview**](../docs/ARCHITECTURE.md) — Deep technical mechanics of Directory Junctions, PowerShell wrappers, and uninstaller isolation.
* [**SDKMAN! Comparison**](../docs/SDKMAN-Comparison.md) — Why and how this project delivers native Windows parity without Linux subsystems.
